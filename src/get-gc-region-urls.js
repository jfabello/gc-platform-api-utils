...
/**
 * @typedef {("us-east-1"|"us-east-2"|"us-west-2"|"ca-central-1"|"eu-west-1"|"eu-west-2"|"eu-central-1"|"eu-central-2"|"ap-south-1"|"ap-northeast-1"|"ap-northeast-2"|"ap-northeast-3"|"ap-southeast-2"|"sa-east-1"|"me-central-1")} GCRegion
 */
 ...
 * @param {GCRegion} gcRegion The Genesys Cloud region.
...
function getGCRegionURLs(gcRegion) {
	...
	// Genesys Cloud regions domains map
	// https://developer.genesys.cloud/platform/api/
	const gcRegionsDomains = {
	...
	if (gcRegion in gcRegionsDomains === false) {
		throw new errors.ERROR_GC_REGION_INVALID();
	}

	const gcDomain = gcRegionsDomains[gcRegion];
